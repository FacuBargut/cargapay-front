        ...
        <aside className="hidden w-64 flex-shrink-0 flex-col bg-gray-800 p-4 text-white md:flex">
          <div>
            ...
            <nav className="mt-8 space-y-2">
              <Link
                href="/dashboard"
                className={`block rounded-md py-2 px-3 ${pathname === '/dashboard' ? 'bg-gray-900' : 'hover:bg-gray-700'}`}
              >
                Dashboard
              </Link>
              <Link
                href="/cargas"
                className={`block rounded-md py-2 px-3 ${pathname === '/cargas' ? 'bg-gray-900' : 'hover:bg-gray-700'}`}
              >
                Cargas
              </Link>
            </nav>
                      ...
                      <tr key={carga.id}>
                        ...
                        <td className="whitespace-nowrap px-6 py-4 text-sm">
                          <span className={`rounded-full px-2 py-1 text-xs font-semibold capitalize ${
                              carga.estado === 'activa' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                          }`}>
                            {carga.estado}
                          </span>
                        </td>
